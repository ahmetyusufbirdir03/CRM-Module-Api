...
public class GetMeetingsByCustomerPhoneNumberOrEmailQueryValidator : AbstractValidator<GetMeetingsByCustomerPhoneNumberOrEmailQueryRequest>
{
    public GetMeetingsByCustomerPhoneNumberOrEmailQueryValidator()
    {
